...
moral benchmarks; value alignment; reflective procedure \# 1.
Introduction
...
\item
  ...
  ethical deliberation of any framing, Buddhist or not, shifted
...
27,000+ per-item records, reproducible on consumer hardware. \# 2.
...
support for the procedural side: static value injection produced no
...
inference cost of a direct answer. Sustained ethical deliberation can be
